...
if __name__ == "__main__":
    ...
    args.exp = 'SimMPNet' + dataset_name + str(args.img_size)
    ...
    net = SimMPNet(n_class=args.num_classes, img_size_s1=(args.img_size,args.img_size), img_size_s2=(224,224), model_scale='small', interpolation='bilinear')

    
    print('Model %s created, param count: %d' %
                     ('SimMPNet: ', sum([m.numel() for m in net.parameters()])))
