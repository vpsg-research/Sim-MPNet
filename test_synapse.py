...
from lib.networks import SimMPNet
...
def inference(args, model, test_save_path=None):
    ...
    for i_batch, sampled_batch in tqdm(enumerate(testloader)):
        ...
        metric_i, pre = test_single_volume(image, label, model, classes=args.num_classes, patch_size=[args.img_size, args.img_size],
...
if __name__ == "__main__":
    ...
    args.exp = 'SimMPNet_' + dataset_name + str(args.img_size)
    snapshot_path = "model_pth/{}/{}".format(args.exp, 'SimMPNet')
    ...
    net = SimMPNet(n_class=args.num_classes, img_size_s1=(args.img_size,args.img_size), img_size_s2=(224,224), model_scale='small', interpolation='bilinear').cuda()
