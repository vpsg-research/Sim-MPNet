...
- Download datasets: Synapse from this [link](https://www.synapse.org/Synapse:syn3193805/wiki/217789), SegPC-2021 from this [link](https://www.kaggle.com/datasets/sbilab/segpc2021dataset), ACDC from this [link](https://www.creatis.insa-lyon.fr/Challenge/acdc/databases.html), ISIC-2018 from this [link](https://challenge.isic-archive.com/data/#2018).
...
cd into Sim-MPNet
```
If you want to train on the Synapse dataset, please modify line 62 of networks.py with num_k=9 and feature_dim=256
If you want to train on the ACDC dataset, please modify line 62 of networks.py with num_k=4 and feature_dim=128
If you want to train on the SegPC-2021 dataset, please modify line 62 of networks.py with num_k=3 and feature_dim=256
If you want to train on the ISIC-2018 dataset, please modify line 62 of networks.py with num_k=2 and feature_dim=256
